...
$e_subject = 'QuickFood beans.Restaurant Review';

// You can change this if you feel that you need to.
$e_body = "You have been contacted by $name_review with the following beans.Restaurant name review: $restaurant_name:" . PHP_EOL . PHP_EOL;
